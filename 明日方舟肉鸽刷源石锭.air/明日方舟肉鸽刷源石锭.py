...
def buqieryu():
    ...
    shijian()
def mujianyuxing():
    touch(Template(r"tpl1642172804442.png", record_pos=(0.156, -0.028), resolution=(1440, 810)))
    shijian()
def xunshouxiaowu():
...
def panduanguanqia():
    ...
    if exists(Template(r"tpl1642045891855.png", threshold=0.8, rgb=True, record_pos=(0.172, -0.028), resolution=(1440, 810))):
        touch(Template(r"tpl1642045891855.png", threshold=0.8, rgb=False, record_pos=(0.172, -0.028), resolution=(1440, 810)))
        shandian()
    elif exists(Template(r"tpl1642165495398.png", threshold=0.8, rgb=True, record_pos=(0.103, 0.026), resolution=(1440, 810))):
        buqieryu()
        ...
        yuchongweiban()
    elif exists(Template(r"tpl1642172804442.png", threshold=0.75, rgb=True, record_pos=(0.156, -0.028), resolution=(1440, 810))):
        mujianyuxing()
